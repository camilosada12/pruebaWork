...
namespace Web.Controllers
{
    ...
    public class RolPizzasPedidosController : GenericController<RolFormPermissions,RolFormPermissionDto>
    {
        /// <summary>
        ...
        public RolPizzasPedidosController(IBaseModelBusiness<RolFormPermissions,RolFormPermissionDto> service, RolFormPermissionRepository extendedService)
            : base(service)
        {
